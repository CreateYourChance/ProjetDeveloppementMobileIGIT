...
public class AdapterUsers extends RecyclerView.Adapter<AdapterUsers.MyHolder> {
    ...
    public interface OnUserClickListener {
        void onUserClick(ModelUsers user);
    }

    // Constructor with the listener parameter
    public AdapterUsers(Context context, List<ModelUsers> list, OnUserClickListener listener) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (onUserClickListener != null) {
                    onUserClickListener.onUserClick(list.get(position));
                }
            }
        });
