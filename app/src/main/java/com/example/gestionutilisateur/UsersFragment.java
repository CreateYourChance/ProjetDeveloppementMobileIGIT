 ...
 */
public class UsersFragment extends Fragment implements AdapterUsers.OnUserClickListener {
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot dataSnapshot1 : dataSnapshot.getChildren()) {
                    ...
                    adapterUsers = new AdapterUsers(getActivity(), usersList, UsersFragment.this);
    ...
    @Override
    public void onUserClick(ModelUsers user) {
        // Handle the user click event, open ChatActivity with user information
        if (getActivity() != null) {
